...
def run_command(command):
    if command == "shutdown /r /t 0" or command == "shutdown /s /t 0":
        if show_restart_shutdown_warning(command):
...
def show_restart_shutdown_warning(command):
    msgBox = QMessageBox()
    msgBox.setIcon(QMessageBox.Warning)
    msgBox.setWindowTitle("Warning")

    if command == "shutdown /r /t 0":
        msgBox.setText("⚠️ You are about to restart the computer. You will lose any unsaved work.\n\n✅ Save your work before doing this opration.\n\n⏰ Are you sure you want to proceed❓")
    elif command == "shutdown /s /t 0":
        msgBox.setText("⚠️ You are about to shut down the computer. You will lose any unsaved work.\n\n✅ Save your work before doing this opration.\n\⏰ nAre you sure you want to proceed❓")
